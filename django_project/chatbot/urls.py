...
from .views import session_history, create_session, ask_chatbot, list_sessions, delete_session, update_chat_session, share_session
...
urlpatterns = [
    ...
    path("share/<uuid:share_uuid>/", share_session, name='share_session'),
]
